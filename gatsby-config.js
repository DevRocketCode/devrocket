  ...
  plugins: [
    'gatsby-plugin-sitemap',
    {
      ...
      options: {
        ...
        trackingIds: [
          "G-R1SZKKGDJJ", // Google Analytics / GA Tag (sends data to Google Analytics)
          "4855531459", // Google Analytics / Measurement ID or Stream ID (identifies this site in Google Analytics)
        ],
