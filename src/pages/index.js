          ...
          <div className="content-container">
            <div className="row">
              <div className="hero-content">
                <div>
                  <h5 className="script-font">Hi I'm</h5>
                  <h2 className="head-title">Preston Wallace</h2>
                  <p className="script-font">Full Stack Software Engineer (and All-Around Nice Guy)</p>
                  ...
                  <button className="button button-info button-small hover-grow">
            ...
            <div className="sm:flex section-padding">
              ...
              <div className="basis-1/2 m-2">
                <div className="profile-wrapper section-padding wow fadeInRight" data-wow-delay="0.3s">
                  <div className="text-3xl font-extrabold text-gray-600">Hello!</div>
